...
export default function ApprovalDetail({ data }) {
  ...
  return (
    <main className="content">
      ...
      <div style={{ display: "flex", gap: "16px", marginTop: "24px" }}>
        <button
          style={{ height: "40px", padding: "0 24px", borderRadius: "6px", background: "#48bb78", color: "white", border: "1px solid #2f855a", fontWeight: "600", cursor: "pointer" }}
        >
          Approve
        </button>
        <button
          style={{ height: "40px", padding: "0 24px", borderRadius: "6px", background: "#dd6b20", color: "white", border: "1px solid #c05621", fontWeight: "600", cursor: "pointer" }}
        >
          Return for Revision
        </button>
        <button
          style={{ height: "40px", padding: "0 24px", borderRadius: "6px", background: "#e53e3e", color: "white", border: "1px solid #c53030", fontWeight: "600", cursor: "pointer" }}
        >
          Reject
        </button>
      </div>
